    ...
    <div class="wrapper">
        ...
        <div class="body">
            <p>Yth. Bapak/Ibu {{ $recipientName }}.</p>
                ...
                <p>
                    Kami ingin memberitahukan bahwa kontrak kerja sama berikut telah diajukan
                    untuk terminasi. Kontrak masih berlaku hingga tanggal efektif terminasi
                    yang ditetapkan.
                </p>
            ...
            <div class="info-box">
                ...
                <p><strong>Tanggal Efektif Terminasi</strong></p>
                <p>{{ $effectiveDate }}</p>
            ...
            <p>
                Setelah tanggal efektif terminasi, kontrak ini akan
                <strong>dihentikan</strong> dan tidak lagi berlaku.
            </p>

            <p>
                Apabila terdapat pertanyaan mengenai pemberitahuan ini,
                silakan menghubungi pihak yang menerbitkan kontrak.
            </p>
