...
<body>
    <div class="wrapper">
        ...
        <div class="header">
            <h1>⏰ Pengingat Kontrak Akan Berakhir</h1>
        </div>

        <div class="body">
            <p>Yth. Bapak/Ibu {{ $recipientName ?? 'Pengguna' }},</p>

            <span class="badge">{{ $days }} hari lagi</span>

            @if($role === 'creator')
                <p>
                    Kami ingin mengingatkan bahwa kontrak yang Bapak/Ibu buat berikut ini akan segera berakhir.
                    Sebagai pembuat kontrak, mohon segera melakukan tindak lanjut perpanjangan apabila diperlukan
                    sebelum tanggal berakhir tiba.
                </p>
            @elseif($role === 'internal')
                <p>
                    Kami ingin mengingatkan bahwa kontrak berikut, yang telah Bapak/Ibu setujui dan tanda tangani,
                    akan segera berakhir. Apabila diperlukan perpanjangan, mohon menghubungi pembuat kontrak
                    terkait untuk tindak lanjut lebih lanjut.
                </p>
            @else
                <p>
                    Kami ingin mengingatkan bahwa kontrak kerja sama berikut antara Bapak/Ibu dengan kami
                    akan segera berakhir. Apabila Bapak/Ibu berkenan untuk memperpanjang kerja sama ini,
                    mohon menghubungi kontak kami agar dapat segera ditindaklanjuti.
                </p>
            @endif
